...
class Files(models.Model):
    Files_Token = models.TextField(max_length=100, default=Random_Token, primary_key=True)
    File_Type_Choice = (
        ('.jpg', 'image'),
        ('.mp4', 'video'),
        ('.mp3', 'audio'),
    ...
    File_Description = models.TextField(max_length=500, default='')
    Files_File = models.FileField(upload_to='res/')
    Files_Type = models.CharField(max_length=10, choices=File_Type_Choice)
